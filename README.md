...
Welcome to **Everquest Guide For Noobs** — a community-maintained beginner's resource for one of the most rewarding (and punishing) MMORPGs ever made.
...
This guide exists to **flatten that brutal learning curve** and help you:
- Understand what kind of game you've gotten yourself into
- Make informed choices about class, race, and server
- Survive your first levels without rage-quitting
- Build habits that will serve you through endgame content

Whether you're a **brand-new player** drawn in by nostalgia or word of mouth, or a **returning veteran** who hasn't logged in since 2004, this guide is for you.
...
### ⚰️ Death Has Real Consequences
Dying in EQ isn't a minor inconvenience. You:
- Drop your **entire inventory** on your corpse
- Lose a **percentage of your current XP** (sometimes enough to de-level)
- Respawn at your bind point, which may be **far from where you died**
- Must retrieve your corpse or lose your items to decay

This makes survival an active goal, not an afterthought.

### 🐢 Slow, Deliberate Pacing
Combat and travel are slow by modern standards. There are no mounts at low levels (on many servers). Getting from one city to another can take **real-world minutes** of running. This isn't bad design — it makes the world feel large and meaningful, and it rewards learning efficient routes and using spells like Spirit of the Wolf or levitation.

### 👥 Built Around Groups
Most dungeons, most XP camps, and most content are **balanced for a full group of 6**. The holy trinity (tank, healer, DPS) is not just a guideline — it's a survival requirement. Finding and maintaining a good group is a core gameplay skill. Your social reputation matters.

### 🧭 No Quest Compass or Map Markers
EQ gives you sparse zone maps (or none at all on early progression servers) with **no automatic objective tracking**. NPCs give you text descriptions and you figure it out. This encourages exploration, note-taking, and community knowledge-sharing — but can feel brutal if you're used to glowing arrows.

### 💬 Player Economy and Crafting
There are no auction houses in the classic sense. Players sell items by **standing in the bazaar or EC tunnel**, typing what they're selling in `/shout` or `/auction`. The economy is entirely player-driven and genuinely interesting as a result. Good traders can make a living; savvy buyers can get incredible deals.

### 🔒 Class Identity Is Rigid and Meaningful
Each class in EQ has a clearly defined role and plays very differently. There is **no hybridization of roles** at the click of a menu. A Warrior cannot heal. A Cleric cannot tank effectively. This makes class choice important and group composition a genuine strategic consideration.

### 😤 No Hand-Holding
There are no tooltips explaining the best rotation, no pop-ups pointing you to the next quest, no achievement system guiding your progression. Learning the game means **engaging with the community**, reading guides (like this one), and experiencing failure. The satisfaction of overcoming that curve is unmatched.

### 🧠 Knowledge Is Power
EQ heavily rewards players who **know the world**. What does this mob drop? Where does this quest NPC spawn? What level do I need to be to survive this zone? These aren't things the game tells you automatically — they're things you learn, research, or ask about. Veteran players have an enormous advantage because of this accumulated knowledge.
...
*Safe travels, adventurer. May your bind point always be close.*
